...
import edu.uky.cs335final.basketball.shader.SkyboxShaderProgram;
import edu.uky.cs335final.basketball.shader.TextureUtils;
import edu.uky.cs335final.basketball.skybox.Skybox;
import edu.uky.cs335final.basketball.util.TextureHelper;
...
public class BasketBallRenderer implements GLSurfaceView.Renderer {
	...
	private static final String TAG = BasketBallRenderer.class
			.getCanonicalName();
...
//move skybox
	private void drawSkybox() {
		...
		translateM(viewMatrix, 0, 0, 0.5f, 0.2f);
		rotateM(viewMatrix, 0, -xRotation, 0f, 1f, 0f);
		multiplyMM(viewMatrix, 0, projectionMatrix, 0, viewMatrix, 0);
		skyboxProgram.useProgram();
		skyboxProgram.setUniforms(viewMatrix, skyboxTexture);
	...
	private BasketBall createBasketBall() {
		...
		int texture = TextureUtils.loadTexture(context,
				R.drawable.basketball_texture);
